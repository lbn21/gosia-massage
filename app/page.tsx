...
const services: IService[] = [
  {
    ...
    description:
      'Allow me to take you on a relaxing journey with my massage therapy. I blend deep tissue techniques, gentle stretching, and the stimulation of acupressure points for a truly rejuvenating experience. Trust me to leave you feeling refreshed and revitalized.',
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      'As a professional therapist, I offer pregnancy massage therapy to address the emotional and physical concerns of expectant mothers. Trust me to provide a sense of security and well-being through this unique and nurturing massage experience.',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1.5rem"
  ...
  },
  {
    ...
    description:
      'Experience relief from muscle pain, improved range of motion, and enhanced recovery from injury with my professional massage therapy. My techniques are designed to also boost circulation and lymphatic flow, leaving you feeling rejuvenated and refreshed. Trust me to provide the support you need to feel your best.',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1.5rem"
    ...
    <>
      <div className="container flex flex-col text-center">
        ...
        <p className="mx-auto my-8 max-w-screen-sm text-lg">
          ...
          needs. Trust me to leave you feeling relaxed and rejuvenated. Book
          your appointment with me today and experience the benefits of massage
          therapy.
        </p>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {prices.map((price) => {
              return (
                <div
                  key={price.title}
                  className="flex flex-col rounded-2xl bg-yellow-700 px-10 py-16 text-white xl:py-20"
                >
                  <p className="font-bold xl:text-xl">{price.title}</p>
                  <p className="text-4xl xl:text-6xl">{price.price}</p>
                </div>
              );
            })}
          </div>
      ...
      {/* Temporary */}
      <Link href={'/blog'} className="btn mx-auto my-10 flex w-fit">
        Blog
      </Link>
    </>
  );
